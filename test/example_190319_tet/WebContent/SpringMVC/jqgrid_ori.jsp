 ...
 /*, datatype : "json" */
	/* , postData : {ajax_post_data: 'hello'}  */
	 ...
	 $.ajax({
         ...
         dataType: "json",
	        ...
	        //    rows = (from row in dt.Select()
	        //            select new
	        //            {
	        //                cell = new string[] {
	        //                        row["MACHINE"].ToString(),
	        //                        row["PREDATE"].ToString(),
	        //                        row["TODATE"].ToString(),
	        //                        row["REAL_DATE"].ToString(),
	        //                     }
	        //            }).ToArray()
	          //  };
	...
	$(document).ready(function () {
		...
		jQuery("#gridMain").jqGrid({
			...
			colNames: ['사번','first_name','department_id','job_id'
				/* , '대분류', '대분류명', '중분류', '중분류명', '소분류', '소분류명', '부하코드', '부하코드명', '단가', '월', '시', '등록일자', '수정일자'
				 */

			],
			colModel: [
					{ name: 'employee_id', index: 'employee_id', width: 100, sorttype: "text" },
					{ name: 'first_name', index: 'first_name', width: 100, sorttype: "text" },
					{ name: 'department_id', index: 'department_id', width: 500, sorttype: "text" },
					{ name: 'job_id', index: 'job_id', width: 500, sorttype: "text" },
