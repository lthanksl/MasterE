function ExportJQGridDataToExcel(tableCtrl, excelFilename) {
    ...
    //var allJQGridData = $(tableCtrl).jqGrid('getGridParam', 'postData');
    ...
    for (i = 0; i < allJQGridData.length; i++) {
        ...
        for (var j = 0; j < columnNames.length; j++) {
            ...
            //cellValue = '' + eval('data.' + columnNames[j])
            cellValue = '' + eval('data["' + columnNames[j] + '"]');   //컬럼명에 괄호가 들어가있을경우..

            //cellValue = '' + data[columnNames[j]];  //인덱스로..
